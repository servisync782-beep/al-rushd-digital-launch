...
const DICT: Dict = {
  ...
  "service.1.body": { en: "Short and long-term rental of cranes, excavators, loaders, forklifts and more.", ar: "تأجير قصير وطويل الأمد للرافعات والحفارات والمحملات والرافعات الشوكية والمزيد." },
  ...
  "service.7.body": { en: "Reliable supply of industrial consumables, PPE and safety equipment for compliant, well-stocked job sites.", ar: "توريد موثوق للمواد الصناعية ومعدات الحماية الشخصية ومعدات السلامة لمواقع العمل المتوافقة والمزودة جيداً." },
  "service.8.title": { en: "Skilled & Semi-Skilled Manpower Supply", ar: "توريد العمالة الماهرة وشبه الماهرة" },
  "service.8.body": { en: "Vetted skilled and semi-skilled labour deployed quickly to keep your projects on schedule.", ar: "عمالة ماهرة وشبه ماهرة مؤهلة يتم توفيرها بسرعة للحفاظ على جدول مشاريعك." },
  "service.9.title": { en: "Asphalt Works & Road Marking", ar: "أعمال الأسفلت وعلامات الطرق" },
  "service.9.body": { en: "Asphalt laying, paving and precise road marking for durable, safe roadways and yards.", ar: "رصف الأسفلت والتبليط وعلامات الطرق الدقيقة للطرق والساحات الآمنة والدائمة." },
  "service.10.title": { en: "Scaffolding Services", ar: "خدمات السقالات" },
  "service.10.body": { en: "Supply, erection and dismantling of certified scaffolding for safe access at any height.", ar: "توريد وتركيب وفك السقالات المعتمدة للوصول الآمن في أي ارتفاع." },
  ...
  "service.12.body": { en: "Light and heavy vehicle rentals to move your teams and materials wherever needed.", ar: "تأجير المركبات الخفيفة والثقيلة لنقل فرقك والمواد أينما لزم الأمر." },
  ...
  "home.clients.eyebrow": { en: "Why Work With Us", ar: "لماذا تعمل معنا" },
  "home.clients.title": { en: "A Growing Partner You Can Count On", ar: "شريك متنامٍ يمكنك الاعتماد عليه" },
  "home.clients.body": {
    en: "We keep our fleet deliberately well-maintained and our service personal. Every unit is inspected before dispatch, and you deal directly with a team that answers quickly and follows through.",
    ar: "نحافظ على أسطولنا بعناية فائقة وخدمتنا شخصية. تُفحص كل وحدة قبل الإرسال، وتتعامل مباشرة مع فريق يرد بسرعة ويلتزم بوعوده.",
  },
  "home.clients.point1.title": { en: "Quality Equipment", ar: "معدات عالية الجودة" },
  "home.clients.point1.body": { en: "Well-maintained, inspection-ready machines.", ar: "آلات مصانة جيداً وجاهزة للفحص." },
  "home.clients.point2.title": { en: "Personal Service", ar: "خدمة شخصية" },
  "home.clients.point2.body": { en: "Direct contact with a responsive team.", ar: "تواصل مباشر مع فريق سريع الاستجابة." },
  "home.clients.point3.title": { en: "Flexible Rentals", ar: "تأجير مرن" },
  "home.clients.point3.body": { en: "Daily, weekly and long-term terms.", ar: "شروط يومية وأسبوعية وطويلة الأمد." },
  "home.clients.point4.title": { en: "Based in Jubail", ar: "مقرنا في الجبيل" },
  "home.clients.point4.body": { en: "Serving the Eastern Province and beyond.", ar: "نخدم المنطقة الشرقية وما بعدها." },
